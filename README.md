...
<head>
    ...
    <style>
        ...
        .flow-step {
            flex: 1 1 200px; /* Ensures blocks grow and shrink equally */
            display: flex;
            flex-direction: column;
            justify-content: center;
        }
...
<body>
    ...
    <div id="slide2" class="slide">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-16 max-w-6xl w-full">
            ...
            <div class="card flex flex-col items-center">
                <p class="text-6xl md:text-7xl mb-2">⏳</p>
                <p class="text-4xl md:text-5xl font-bold text-accent-teal">20+ Years</p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl w-full">
            <div class="card text-left">
                ...
                <ul class="list-none space-y-4">
                    <li><span class="text-accent-teal text-xl md:text-2xl mr-2">✅</span><span class="font-semibold">Low Cost:</span> Inexpensive, accessible technology (e.g., Kon-Tiki kilns) requires minimal upfront investment.</li>
            ...
            <div class="card text-left">
                ...
                <ul class="list-none space-y-4">
                    ...
                    <li><span class="text-accent-gold text-xl md:text-2xl mr-2">⚠️</span><span class="font-semibold">Challenge:</span> High capital costs and risk of feedstock competition.</li>
                </ul>
            </div>
        </div>
    ...
    <div id="slide5" class="slide">
        ...
        <div class="max-w-4xl w-full text-left space-y-6">
            ...
            <div class="card">
                <h3 class="text-xl md:text-2xl font-bold text-accent-gold mb-2">2. Low Permanence & Reversal</h3>
                <p class="text-gray-600">Mandate the use of standardized kilns that produce high-carbon biochar and require immediate soil application rather than long-term stockpiling.</p>
            </div>
            <div class="card">
                <h3 class="text-xl md:text-2xl font-bold text-accent-gold mb-2">3. Inconsistent Quality</h3>
            ...
            <div class="card">
                <h3 class="text-xl md:text-2xl font-bold text-accent-gold mb-2">4. Community Disruption</h3>
                <p class="text-gray-600">Work through established FPOs and NGOs to ensure equitable benefit sharing and co-ownership from the outset.</p>
            </div>
            <div class="card">
                <h3 class="text-xl md:text-2xl font-bold text-accent-gold mb-2">5. High MRV Costs</h3>
